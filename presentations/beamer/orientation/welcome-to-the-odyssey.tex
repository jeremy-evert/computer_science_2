...
\begin{designdecisionframe}{Your Choices Create Consequences}
  \begin{itemize}
    ...
    \item An earlier design choice may matter again in Week 12
  \end{itemize}
  \vspace{2mm}
...
\begin{worldbibleframe}{The World Bible Remembers}
  \begin{worldbibleentry}{What the World Bible Actually Is}
    ...
    \wbfield{Why it matters}{When Week 12 exposes a consequence of a Week 4 decision, this is what you consult -- and what you cite in your defense.}
  \end{worldbibleentry}
\end{worldbibleframe}

% 7. Evidence to produce -- weekly gates
\begin{evidenceframe}{Weekly Gates Produce Evidence of Progress}
  Weeks 3--5, 7--8, and 10--13: a small, gradable evidence package, not a
...
\begin{odysseygateframe}{Checkpoints Ask You to Defend a Larger Capability}
  ...
  \begin{itemize}
    \item \textbf{Week 6} (40 pts) -- a baby-project contract and swap
    \item \textbf{Week 9} (50 pts) -- a GUI/model or data-story synthesis
    \item \textbf{Week 14} (60 pts) -- a professional workflow receipt and full trail debrief
  \end{itemize}
  \vspace{2mm}
...
\begin{exitframe}{What Happens Next}
  \Large\color{cs2primary}
  \textbf{Pick your world. Week 3 is where the first gate opens.}

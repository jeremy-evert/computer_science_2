"""Vendored transparent experience-table learner from hardened CS1."""
...
class ExperienceTable:
    ...
    def as_strategy(self):
        ...
        learned_strategy.description = (
            "Whatever the experience table currently believes is best."
        )
...
def train_one_turn(rng, table):
    ...
    while True:
        ...
        state = engine.build_state(
            turn_score, dice_remaining, total_score=0, target_score=0,
            opponent_score=None,
        )

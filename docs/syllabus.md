...
|---|---|
| Course | COMSC 1053 — Computer Science II |
| Section | COMSC-1053-1417 |
| Modality | Traditional / in person |
| Meeting | Monday / Wednesday / Friday, 1:00–1:50 PM |
| Location | Gen. Thomas P. Stafford Center, Room 259 |
| Term | Fall 2026, Aug 17–Dec 11, 2026; finals Dec 7–11 |
| Prerequisite | COMSC 1033 |

## Course description

A continuation of Computer Science I. Object-oriented concepts such as inheritance, encapsulation, polymorphism, abstract classes and interfaces are studied along with event-driven programming, classic data structures, object-oriented thinking and design, modularity, debugging, documentation, and source-code management in collaborative work.

## Course purpose

Move from small introductory programs toward intentional object design, collaboration, data abstractions, honest data visualization/storytelling, modest event-driven interfaces, and a professional workflow that leaves reviewable evidence.

## Required materials and resources

- Python 3 and the approved course development environment.
- Canvas access and a reliable way to submit code, evidence, and explanations.
- No required textbook or paid external course. Course-owned materials and no-cost references are the active resource path; ZyBooks/Deitel remain optional historical/reference material only.
- Shared Week 2 local-AI readiness work may use course-provided local tools. Paid AI subscriptions are not required.
...
1. Design cohesive encapsulated objects and collaborating components.
2. Compare composition and inheritance and use polymorphism when it earns its complexity.
3. Use contracts/interfaces and classic data abstractions with evidence of behavior.
4. Build and test a modest event-driven interface while keeping model behavior independently testable.
5. Use project data to make readable visualizations and evidence-backed claims with limitations.
6. Use source management, testing, recovery, documentation, and bounded AI assistance in a reviewable professional workflow.

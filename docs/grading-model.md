# COMSC-1053 — Grading Model (Fall 2026 reconciliation)
...
is reflection/closure, not a technical final.

The previously recorded category percentages are historical proposed values;
they must be confirmed at syllabus finalization rather than silently treated
as a new decision in this reconciliation.
...
- Confirm category weights and any checkpoint/review allocation.
- Confirm finals policy, drop/late rules, submission locations, and automated-feedback role.
- Decide any bonus mechanism without creating a required parallel practice track.
- Verify classroom container runtime before making a runnable container activity required.
